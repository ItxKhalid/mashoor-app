...
class CategoryRepo {
  ...
  Future<Response> getCityListByCategory(String catID) async {
    return await apiClient.getData('${AppConstants.CITY_LIST_BY_CATEGORY_URI}$catID');
  }

  Future<Response> getSeasonalProduct() async {
    return await apiClient.getData('${AppConstants.SEASONAL_PRODUCT_URI}');
  }
