...
class _CheckoutScreenState extends State<CheckoutScreen> {
                  ...
                  return GetBuilder<CouponController>(
                    ...
                    return GetBuilder<OrderController>(
                      ...
                      if (restController.restaurant != null &&
                        ...
                        print(
                            " 0 setting actual delivery cost $_deliveryCharge ");
                        ...
                        _deliveryCharge = orderController.distance *
                            Get.find<SplashController>()
                                ...
                                .perKmShippingCharge;
                        print(
                            " 1 setting actual delivery cost $_deliveryCharge ");
                        ...
                        if (_deliveryCharge <
                          ...
                          _deliveryCharge = Get.find<SplashController>()
                              ...
                              .minimumShippingCharge;
                          print(
                              " 2 setting actual delivery cost $_deliveryCharge ");
                          //   setState(() {
                      ...
                      if (restController.restaurant != null) {
                        ...
                        if (orderController.orderType == 'take_away' ||
                          ...
                          _deliveryCharge = 0;
                          print(
                              "setting delivery charges .... $_deliveryCharge ");
                        }
                      }
                      // @ asrar - tax removed
                      ...
                      double _total = 0;
                      print("printing tabindex >> $_tabTextIconIndexSelected ");
  ...
  Future<void> makePayment() async {
    try {
      ...
      //     .then((value) {
      //
      //       print("real payment done");
      //       print('REAL payment intent' + paymentIntentData['id'].toString());
      //       print('REAL payment intent' + paymentIntentData['client_secret'].toString());
      //       print('REAL payment intent' + paymentIntentData['amount'].toString());
      //       print('REAL payment intent' + paymentIntentData.toString());
      // });
  ...
  displayPaymentSheet() async {
    try {
      await Stripe.instance
        ...
        if (is_user_charged) {
          print(
              "yes actually placing order from digital payment and payment is  $_total");
          getOrderPlaced(
              this.orderController,
              this.locationController,
              this.carts,
      ...
      print("-- printing error in stripe $e");
      print('$e');
    }
  }
  ...
  Future<Map<String, dynamic>> createPaymentIntent(
    ...
    try {
      ...
      //     final int aPay = (int.parse(_totalToPay.toString()));
      //   String pay = aPay.toString();
      //    print("-- total to pay afer  ****** $pay");
      Map<String, dynamic> body = {
        'amount': (_totalToPay.round() * 100).toString(),
        'currency': currency,
      ...
      var response = await http.post(
          ...
          body: body,
          headers: {
            // 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
            // sk_test_51JCskPGJw4LwnASwJERnuogL4q8PUP3b6Bhaq9jCatRtCA32vSRzI7VyktZIGv2423ZZEU4F3aremQI6QnujK4dl00zCaIVbyD
            'Authorization':
