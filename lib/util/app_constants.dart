...
class AppConstants {
  static const String APP_NAME = 'Mashoor App';
  static const int APP_VERSION = 1;
  static const int SLOT_IN_MINUTE = 30;
  static const int DIGITS_AFTER_POINT = 2;
  static const String BASE_URL = 'https://s3bits.com/mashhoor';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String SEASONAL_PRODUCT_URI = '/api/v1/products/get-season';
  static const String CITY_LIST_BY_CATEGORY_URI = '/api/v1/categories/city/';
  ...
  static const String CITY_URI = '/api/v1/categories/get-city';
